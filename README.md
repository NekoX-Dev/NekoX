...
** Outdated [because](https://developer.android.com/distribute/best-practices/develop/target-sdk) the target api level 29 is not supported by upstream. Otherwise, the play version won't be able to read photos and files (like other 3rd apps do).**
