    ...
    private boolean createMenuForParticipant(final TLObject participant, boolean resultOnly, View view) {
        ...
        if (type == TYPE_USERS) {
            ...
            ItemOptions.makeOptions(this, view)
                ...
                .addIf(allowSetAdmin, R.drawable.baseline_stars_24, editingAdmin ? LocaleController.getString("EditAdminRights", R.string.EditAdminRights) : LocaleController.getString("SetAsAdmin", R.string.SetAsAdmin), () -> openRightsFor.run(0))
                .addIf(canChangePermission, R.drawable.baseline_block_24, LocaleController.getString("ChangePermissions", R.string.ChangePermissions), () -> {
                ...
                .addIf(ChatObject.canBlockUsers(currentChat) && canEditAdmin, R.drawable.baseline_block_24, isChannel ? LocaleController.getString("ChannelRemoveUser", R.string.ChannelRemoveUser) : LocaleController.getString("KickFromGroup", R.string.KickFromGroup), true, () -> {
                    getMessagesController().deleteParticipantFromChat(chatId, user);
                    removeParticipants(peerId);
            ...
            if (type == TYPE_KICKED && ChatObject.canBlockUsers(currentChat)) {
                options.add(R.drawable.baseline_block_24, LocaleController.getString("ChannelEditPermissions", R.string.ChannelEditPermissions), () -> {
                ...
                options.add(R.drawable.baseline_delete_24, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), true, () -> deletePeer(peerId));
            } else if (type == TYPE_BANNED && ChatObject.canBlockUsers(currentChat)) {
                if (ChatObject.canAddUsers(currentChat) && peerId > 0) {
                    options.add(R.drawable.baseline_person_add_24, isChannel ? LocaleController.getString("ChannelAddToChannel", R.string.ChannelAddToChannel) : LocaleController.getString("ChannelAddToGroup", R.string.ChannelAddToGroup), () -> {
                        TLRPC.User user = getMessagesController().getUser(peerId);
                ...
                if (currentChat.creator || !(participant instanceof TLRPC.TL_channelParticipantCreator)) {
                    options.add(R.drawable.baseline_stars_24, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), () -> {
                ...
                options.add(R.drawable.baseline_remove_circle_24, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), true, () -> {
