            ...
            switch (viewType) {
                ...
                case VIEW_TYPE_FILTER:
                    ...
                    filterCell.setOnOptionsClick(v -> {
                        ...
                        options.add(R.drawable.baseline_edit_24, LocaleController.getString("FilterEditItem", R.string.FilterEditItem), () -> {
                            if (filter.locked) {
                        ...
                        options.add(R.drawable.baseline_delete_24, LocaleController.getString("FilterDeleteItem", R.string.FilterDeleteItem), true, () -> {
