...
class BottomBuilder(val ctx: Context) {
    ...
    fun addEditText(hintText: String): EditText {
        ...
        return EditText(ctx).apply {
            ...
            this@BottomBuilder.rootView.addView(this, LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, -2, if (LocaleController.isRTL) Gravity.RIGHT else Gravity.LEFT, AndroidUtilities.dp(14F), 0, 0, 0))
